...
class Search {
    ...
    query(query, startrow, maxrow, startDate, endDate, senderId, threadId) {
        return new Promise((resolve, reject) => {
            ...
            var q = this.getEnhancedQuery(query);

            //tokenize hashtagQuery
            //put the ones starting with $ or # to array and remove from the query
            ...
            console.log('searching for args:' + args.toString());

            let searchBinExecPath = path.join(electron.app.getAppPath(), SEARCHBIN);
            childProcess.execFile(searchBinExecPath,args,(error,stdout,stderr) => {
                if(error) {
